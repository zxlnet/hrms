...
namespace GotWell.Utility
{
    public class UtilValidator
    {
        ...
        public static bool IsIPV6(string input)
        {
            ...
            int count = UtilValidator.GetStringCount(input, "::");
            if (count > 1)
            {
                return false;
            }
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static bool IsDateCN(string input)
        {
            string pattern = @"(\S{1,4})年(\S{1,2})月(\S{1,3})日";
            Regex regex = new Regex(pattern);
            return regex.IsMatch(input);
        }
        ...
        {
            string pattern = @"\([0-9]\{4\}[ /-.][0-2][0-9][ /-.][0-3][0-9]\)";
            Regex regex = new Regex(pattern);
            return regex.IsMatch(input);
        }
