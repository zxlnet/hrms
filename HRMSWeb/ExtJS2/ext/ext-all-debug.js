...
Ext.form.NumberField = Ext.extend(Ext.form.TextField,  {
    ...
    getValue : function(){
        return this.addZero(this.fixPrecision(this.parseValue(Ext.form.NumberField.superclass.getValue.call(this))));
    },
    ...
    addZero: function(v){
          var v1 = v.toString();  
          if ((this.keepZero) && (v1.indexOf(this.decimalSeparator)<0)) {
	            var x = v1 + this.decimalSeparator + String.leftPad('',this.decimalPrecision,'0');
	            return x;
	      }
	      else
	      {
