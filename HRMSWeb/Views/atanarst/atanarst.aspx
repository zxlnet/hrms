<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="atanarst.aspx.cs" Inherits="GotWell.HRMS.HRMSWeb.Views.atanarst.atanarst" %>
...
var atanarstConfig=Ext.decode('<%=ViewData["config"] %>'); 
atanarstConfig.auth=Ext.decode('<%=ViewData["authorization"] %>');
var atanarstPageName = 'atanarst';
var atanarstKeyColumn='emno';
            
var atanarstQueryWindow=function(grid){
	this.grid=grid;
	this.store=this.grid.getStore();
	this.init();	
	
	atanarstQueryWindow.superclass.constructor.call(this,{
        layout:'fit', 
        width:400, 
        height:300, 
        closeAction:'close', 
...
Ext.extend(atanarstQueryWindow,Ext.Window,{
    init:function(){
		...
		return new Ext.FormPanel({   
             ...
             items: [
                     ...
                     items: [{xtype:'datefield',fieldLabel:HRMSRes.Attendance_Label_atdt + '' + HRMSRes.Public_Label_To,id:'to|atdt',
                        name:'to|tdt',editable:false,height:22,anchor:'95%',
                        format: DATE_FORMAT.DATEONLY,minValue: '1980/01/01',
           	 	        invalidText : '{0} '+ HRMSRes.Public_Messsage_FormatInCorrect +' {1}'}]},
...
var atanarstEditWindow=function(grid,isNew){
	this.grid=grid;
	this.isNew=isNew||false;
	this.store=this.grid.getStore();
	this.init();	

	atanarstEditWindow.superclass.constructor.call(this,{
        layout:'fit', 
        width:650, 
        height:350, 
        ...
        listeners:{
            show:function(){              
		        var keyField = this.basisForm.findField(atanarstKeyColumn);
                ...
                setLastModifiedInfo(atanarstConfig,this.basisForm);
            },
            scope:this
        },
        buttons: [{ 
...
Ext.extend(atanarstEditWindow,Ext.Window,{
    init:function(){
      		    ...
      		    items:[
                    ...
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Public_Label_staff + '(<font color=red>*</font>)',
                     ...
                     items: [{xtype:'datefield',fieldLabel:HRMSRes.Attendance_Label_atdt + '(<font color=red>*</font>)' ,id:'atdt',
                        name:'atdt',editable:false,height:22,anchor:'95%',allowBlank:false,
                        format: DATE_FORMAT.DATEONLY,minValue: '1980/01/01',stateful:false,disabled:false,
           	 	        invalidText : '{0} '+ HRMSRes.Public_Messsage_FormatInCorrect +' {1}'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_athr,
                        name: 'athr',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_intm,format:DATE_FORMAT.TIMEONLY,
                        name: 'intm',stateful:false,anchor:'95%'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_itmm,format:DATE_FORMAT.TIMEONLY,
                        name: 'itmm',stateful:false,anchor:'95%'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_ottm,format:DATE_FORMAT.TIMEONLY,
                        name: 'ottm',stateful:false,anchor:'95%'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_otmm,format:DATE_FORMAT.TIMEONLY,
                        name: 'otmm',stateful:false,anchor:'95%'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_brst,format:DATE_FORMAT.TIMEONLY,
                        name: 'brst',stateful:false,anchor:'95%'}]},
                     ...
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_bstm,format:DATE_FORMAT.TIMEONLY,
      		        ...
      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'timefield',fieldLabel:HRMSRes.Attendance_Label_bret,format:DATE_FORMAT.TIMEONLY,
                        name: 'bret',stateful:false,anchor:'95%'}]},
                    ...
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Attendance_Label_sfnm ,
                        name: 'sfcd',stateful:false,typeAhead: true,
                        triggerAction: 'all',mode: 'local',maxHeight:150,anchor:'95%',disabled:!this.isNew,
                    ...
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Attendance_Label_rsnm ,
                        ...
                        store: new Ext.data.Store({ 
		                    ...
		                    listeners:{load:function(){var f =this.basisForm.findField('rscd') ;f.setValue(f.getValue());},scope:this}
		                    })
    		          }]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'textfield',fieldLabel:HRMSRes.Attendance_Label_atst,
                        name: 'atst',stateful:false,anchor:'95%'}]},

                    {columnWidth:.5,layout: 'form',
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Attendance_Label_ifma ,
                        name: 'ifma',stateful:false,editable:false,typeAhead: true,
                        triggerAction: 'all',mode: 'local',maxHeight:150,anchor:'95%',
                        displayField: 'text',valueField:'value',value:'N',
                        store: FlagYesNoStore}]},

                    {columnWidth:.5,layout: 'form',
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Attendance_Label_iscf ,
                        name: 'iscf',stateful:false,editable:false,typeAhead: true,
                        triggerAction: 'all',mode: 'local',maxHeight:150,anchor:'95%',
                        displayField: 'text',valueField:'value',value:'N',
                        store: FlagYesNoStore}]},

                    {columnWidth:.5,layout: 'form',
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Attendance_Label_isrt ,
                        name: 'isrt',stateful:false,editable:false,typeAhead: true,
                        triggerAction: 'all',mode: 'local',maxHeight:150,anchor:'95%',
                        displayField: 'text',valueField:'value',value:'N',
                        store: FlagYesNoStore}]},
	...
	save: function(){
		...
		Ext.Ajax.request({
		   url: ContextInfo.contextPath+'/' + atanarstPageName + '.mvc/'+method,
...
var atanarstPanel=function(){
    this.tabId=atanarstConfig.tabId;
	this.init();	
	
	atanarstPanel.superclass.constructor.call(this,{
		applyTo:this.tabId, 
	    layout:'fit',
...
//	            hidden:atanarstConfig.auth[this.tabId+'_' + 'add']!='True',
//	            handler: function(){
//	                new atanarstEditWindow(this.grid,true).show();            	
//	            }, 
//	            scope: this 
//	        },'-',
//	        
	        { 
	            ...
	            hidden:atanarstConfig.auth[this.tabId+'_' + 'edit']!='True',
	            handler: function(){
	            	new atanarstEditWindow(this.grid).show(); 
	            }, 
	            scope: this
	        },{ 
	            id:this.tabId+ '_delete',
                iconCls:'icon-remove', 
                hidden:atanarstConfig.auth[this.tabId+'_' + 'delete']!='True',
	            ...
	            iconCls:'icon-query', 
	            text:HRMSRes.Public_Toolbar_Query,
	            hidden:atanarstConfig.auth[this.tabId+'_' + 'query']!='True',
	            handler: function(){
	            	new atanarstQueryWindow(this.grid).show();
	            }, 
	            scope: this
	        },'-',{ 
	            ...
	            hidden:atanarstConfig.auth[this.tabId+'_' + 'exportexcel']!='True',
	            handler: this.exportExcel, 
	            scope: this 
	        },'->',{ 
	        	xtype:'label', 
	            html:  '<b><font color=green>employee no: ' + atanarstConfig.emno + '</font></b>',
	            hidden: atanarstConfig.emno==''
	        },'->',{ 
                ...
                id:this.tabId+'_muf',
                iconCls:atanarstConfig.muf=='True'?'icon-mufdelete':'icon-mufadd', 
                text:'', 
                handler: function(){updateMUF(this.tabId,atanarstConfig.muf?'delete':'add',atanarstConfig,this.grid);},
                scope: this 
            }],  
	        items:this.grid
       }]
...
Ext.extend(atanarstPanel,Ext.Panel,{
    init:function(){
	...
	createGridPanel:function(){
		...
		var atanarstStoreType=Ext.data.Record.create([
		    {name:'emno'},
            {name:'sfid'},
            {name:'stfn'},
		...
		var store=new Ext.data.Store({ 
        	reader: new Ext.data.JsonReader({
	   	    ...
	   	    baseParams:{record:Ext.encode({params:[{ColumnName:atanarstKeyColumn,ColumnValue:atanarstConfig.emno},
	   	                                            {ColumnName:'atdate',ColumnValue:formatDate(new Date())}]})},   
	   		url:ContextInfo.contextPath+'/' + atanarstPageName + '.mvc/list',
	   		listeners:{
        ...
        return new Ext.grid.GridPanel({
            ...
            cm: new Ext.grid.ColumnModel([ 
                ...
                {header:HRMSRes.Attendance_Label_intm,sortable: true, dataIndex: 'intm',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_itmm,sortable: true, dataIndex: 'itmm',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_ottm,sortable: true, dataIndex: 'ottm',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_otmm,sortable: true, dataIndex: 'otmm',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_brst,sortable: true, dataIndex: 'brst',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_bstm,sortable: true, dataIndex: 'bstm',renderer:formatTime},
                {header:HRMSRes.Attendance_Label_bret,sortable: true, dataIndex: 'bret',renderer:formatTime},
                ...
                {header:HRMSRes.Attendance_Label_atst,sortable: true, dataIndex: 'atst'},
                ...
                {header:HRMSRes.Attendance_Label_ifma,sortable: true, dataIndex: 'ifma'},
                {header:HRMSRes.Attendance_Label_iscf,sortable: true, dataIndex: 'iscf'},
                {header:HRMSRes.Attendance_Label_isrt,sortable: true, dataIndex: 'isrt'}
            ]),
	...
	remove:function(){
	    ...
	    Ext.MessageBox.show({
	        ...
	        fn: function(btn, text){
		        if (btn=='yes'){
			        Ext.Ajax.request({
	   			        url:ContextInfo.contextPath+ '/'+ atanarstPageName + '.mvc/delete',
	   			        success: function(response){
	   				        var o= Ext.util.JSON.decode(response.responseText);
	   				        if(o.status=='success'){
	...
	exportExcel:function(){
	    ...
	    var params={record:Ext.encode({params:[{ColumnName:atanarstKeyColumn,ColumnValue:''}],headers:header})};
	    ...
	    form.name='excelForm';
	    form.method='post';
	    form.action=ContextInfo.contextPath+ '/' + atanarstPageName + '.mvc/exportexcel';
	    for(var p in params){
