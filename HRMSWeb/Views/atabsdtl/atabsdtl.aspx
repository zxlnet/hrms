<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="atabsdtl.aspx.cs" Inherits="GotWell.HRMS.HRMSWeb.Views.atabsdtl.atabsdtl" %>
...
var atabsdtlConfig=Ext.decode('<%=ViewData["config"] %>'); 
atabsdtlConfig.auth=Ext.decode('<%=ViewData["authorization"] %>');
var atabsdtlPageName = 'atabsdtl';
var atabsdtlKeyColumn='emno';
            
var atabsdtlQueryWindow=function(grid){
	this.grid=grid;
	this.store=this.grid.getStore();
	this.init();	
	
	atabsdtlQueryWindow.superclass.constructor.call(this,{
        layout:'fit', 
        width:400, 
        height:270, 
        closeAction:'close', 
...
Ext.extend(atabsdtlQueryWindow,Ext.Window,{
    init:function(){
		...
		return new Ext.FormPanel({   
             ...
             items: [
                     ...
                     items: [{xtype:'textfield',fieldLabel:HRMSRes.Public_Label_sftn,
      		        ...
      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'datefield',fieldLabel:HRMSRes.Attendance_Label_atdt,id:'from|atdt',
     		        ...
     		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'datefield',fieldLabel:HRMSRes.Attendance_Label_atdt,id:'to|atdt',
...
var atabsdtlEditWindow=function(grid,isNew){
	this.grid=grid;
	this.isNew=isNew||false;
	this.store=this.grid.getStore();
	this.init();	

	atabsdtlEditWindow.superclass.constructor.call(this,{
        layout:'fit', 
        width:650, 
        height:350, 
        ...
        listeners:{
            show:function(){              
		        var keyField = this.basisForm.findField(atabsdtlKeyColumn);
...
//		        else
//		        {
//		            keyField.setValue(atabsdtlConfig.emno);
//		            if (atabsdtlConfig.emno!='')
//		                getMaxsqno(atabsdtlConfig.emno,atabsdtlConfig.tableName,this.basisForm);
//		        }
		        var keyValue = keyField.getValue();
                setLastModifiedInfo(atabsdtlConfig,this.basisForm);
            },
            scope:this
        },
        buttons: [{ 
...
Ext.extend(atabsdtlEditWindow,Ext.Window,{
    init:function(){
      		 ...
      		 items: [
      		    ...
      		    items:[
                    ...
                    items: [{xtype:'combo',fieldLabel:HRMSRes.Public_Label_staff + '(<font color=red>*</font>)',
     		        ...
     		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'datefield',fieldLabel:HRMSRes.Attendance_Label_atdt,id:'atdt',
                        name:'atdt',editable:false,height:22,anchor:'95%',
                        format: DATE_FORMAT.DATEONLY,minValue: '1980/01/01',stateful:false,disabled:false,
           	 	        invalidText : '{0} '+ HRMSRes.Public_Messsage_FormatInCorrect +' {1}'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_lact,
                        name: 'lact',stateful:false,anchor:'95%',decimalPrecision:0,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_lctm,
                        name: 'lctm',stateful:false,anchor:'95%',decimalPrecision:0,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_ahrr,
                        name: 'ahrr',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_eact,
                        name: 'eact',stateful:false,anchor:'95%',decimalPrecision:0,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_ectm,
                        name: 'ectm',stateful:false,anchor:'95%',decimalPrecision:0,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_abda,
                        name: 'abda',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},
                     ...
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_adam,
      		        ...
      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_abhr,
                        name: 'ahrs',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},
                     ...
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_ahrm,
      		        ...
      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_eahr,
                        name: 'eahr',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_ehrm,
                        name: 'ehrm',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_lahr,
                        name: 'lahr',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},

      		        {columnWidth:.5,layout: 'form',
                     items: [{xtype:'numberfield',fieldLabel:HRMSRes.Attendance_Label_lhrm,
                        name: 'lhrm',stateful:false,anchor:'95%',decimalPrecision:2,keepZero:true,value:'0'}]},
	...
	save: function(){
		...
		Ext.Ajax.request({
		   url: ContextInfo.contextPath+'/' + atabsdtlPageName + '.mvc/'+method,
...
var atabsdtlPanel=function(){
    this.tabId=atabsdtlConfig.tabId;
	this.init();	
	
	atabsdtlPanel.superclass.constructor.call(this,{
		applyTo:this.tabId, 
	    layout:'fit',
	    ...
	    items:[{
	        ...
	        tbar: [{ 
	            ...
	            hidden:atabsdtlConfig.auth[this.tabId+'_' + 'add']!='True',
	            handler: function(){
	                new atabsdtlEditWindow(this.grid,true).show();            	
	            }, 
	            scope: this 
	        },'-',{ 
	        	id:this.tabId+ '_edit',
	            ...
	            hidden:atabsdtlConfig.auth[this.tabId+'_' + 'edit']!='True',
	            handler: function(){
	            	new atabsdtlEditWindow(this.grid).show(); 
	            }, 
	            scope: this
	        },{ 
	            id:this.tabId+ '_delete',
                iconCls:'icon-remove', 
                hidden:atabsdtlConfig.auth[this.tabId+'_' + 'delete']!='True',
	            ...
	            iconCls:'icon-query', 
	            text:HRMSRes.Public_Toolbar_Query,
	            hidden:atabsdtlConfig.auth[this.tabId+'_' + 'query']!='True',
	            handler: function(){
	            	new atabsdtlQueryWindow(this.grid).show();
	            }, 
	            scope: this
	        },'-',{ 
	            ...
	            hidden:atabsdtlConfig.auth[this.tabId+'_' + 'exportexcel']!='True',
	            handler: this.exportExcel, 
	            scope: this 
	        },'->',{ 
	        	xtype:'label', 
	            html:  '<b><font color=green>employee no: ' + atabsdtlConfig.emno + '</font></b>',
	            hidden: atabsdtlConfig.emno==''
	        },'->',{ 
                ...
                id:this.tabId+'_muf',
                iconCls:atabsdtlConfig.muf=='True'?'icon-mufdelete':'icon-mufadd', 
                text:'', 
                handler: function(){
                        updateMUF(this.tabId,atabsdtlConfig.muf?'delete':'add',atabsdtlConfig,this.grid);
                },
                scope: this 
            }], 
	        items:this.grid
...
Ext.extend(atabsdtlPanel,Ext.Panel,{
    init:function(){
	...
	createGridPanel:function(){
		...
		var atabsdtlStoreType=Ext.data.Record.create([
		    {name:'emno'},
            {name:'sfid'},
            {name:'stfn'},
		...
		var store=new Ext.data.Store({ 
        	reader: new Ext.data.JsonReader({
	   	    ...
	   	    baseParams:{record:Ext.encode({params:[{ColumnName:atabsdtlKeyColumn,ColumnValue:atabsdtlConfig.emno}]})},   
	   		url:ContextInfo.contextPath+'/' + atabsdtlPageName + '.mvc/list',
	   		listeners:{
        ...
        return new Ext.grid.GridPanel({
            ...
            cm: new Ext.grid.ColumnModel([ 
                ...
                {header:HRMSRes.Attendance_Label_atdt,sortable: true, dataIndex: 'atdt',type:'date',renderer:formatDateNoTime},
                {header:HRMSRes.Attendance_Label_lact,sortable: true, dataIndex: 'lact',align:'right'},
                {header:HRMSRes.Attendance_Label_lctm,sortable: true, dataIndex: 'lctm',align:'right'},
                {header:HRMSRes.Attendance_Label_ahrr,sortable: true, dataIndex: 'ahrr',align:'right'},
                {header:HRMSRes.Attendance_Label_eact,sortable: true, dataIndex: 'eact',align:'right'},
                {header:HRMSRes.Attendance_Label_ectm,sortable: true, dataIndex: 'ectm',align:'right'},
                {header:HRMSRes.Attendance_Label_abda,sortable: true, dataIndex: 'abda',align:'right'},
                {header:HRMSRes.Attendance_Label_adam,sortable: true, dataIndex: 'adam',align:'right'},
                {header:HRMSRes.Attendance_Label_abhr,sortable: true, dataIndex: 'ahrs',align:'right'},
                {header:HRMSRes.Attendance_Label_ahrm,sortable: true, dataIndex: 'ahrm',align:'right'},
                {header:HRMSRes.Attendance_Label_eahr,sortable: true, dataIndex: 'eahr',align:'right'},
                {header:HRMSRes.Attendance_Label_ehrm,sortable: true, dataIndex: 'ehrm',align:'right'},
                {header:HRMSRes.Attendance_Label_lahr,sortable: true, dataIndex: 'lahr',align:'right'},
                {header:HRMSRes.Attendance_Label_lhrm,sortable: true, dataIndex: 'lhrm',align:'right'}
            ]),
	...
	remove:function(){
	    ...
	    Ext.MessageBox.show({
	        ...
	        fn: function(btn, text){
		        if (btn=='yes'){
			        Ext.Ajax.request({
	   			        url:ContextInfo.contextPath+ '/'+ atabsdtlPageName + '.mvc/delete',
	   			        success: function(response){
	   				        var o= Ext.util.JSON.decode(response.responseText);
	   				        if(o.status=='success'){
	...
	exportExcel:function(){
	    ...
	    var params={record:Ext.encode({params:[{ColumnName:atabsdtlKeyColumn,ColumnValue:''}],headers:header})};
	    ...
	    form.name='excelForm';
	    form.method='post';
	    form.action=ContextInfo.contextPath+ '/' + atabsdtlPageName + '.mvc/exportexcel';
	    for(var p in params){
